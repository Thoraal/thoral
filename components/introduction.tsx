...
const Introduction = () => {
    return (
        <div className="z-20 w-full bg-darkBg/60">
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2 my-3">
            <Image src="/home-4.png" priority layout="intrinsic"  width={180} height={180} alt="Avatar" className="mx-auto md:w-[330px] md:h-[330px]"/>
